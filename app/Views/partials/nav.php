            ...
            <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                ...
                <div class="hidden sm:ml-6 sm:block">
                    <div class="flex space-x-4">
                        ...
                        <a href="/dashboard"
                            class="<?= isUrl('/dashboard') ? 'bg-gray-900' : 'bg-gray-800' ; ?> rounded-md px-3 py-2 text-sm font-medium text-white"
                            aria-current="page">Dashboard</a>
                        <a href="/about"
                            class="<?= isUrl('/about') ? 'bg-gray-900' : 'bg-gray-800' ; ?> rounded-md px-3 py-2 text-sm font-medium text-white hover:bg-gray-700"
                            aria-current="page">About</a>
                        <a href="/notes"
                            class="<?= isUrl('/contact') ? 'bg-gray-900' : 'bg-gray-800' ; ?> rounded-md  px-3 py-2 text-sm font-medium text-white hover:bg-gray-700"
            ...
            <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                <div
                    ...
                    <?php else : ?>
                        ...
                        In</a>
                    <a href="/register"
                        class="text-white bg-indigo-700 hover:bg-indigo-500 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2  dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Sign
                        In</a>
                    <?php endif; ?>
